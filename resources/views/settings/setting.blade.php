            ...
            <div class="row">
                <div class="col-xl-3">
                    <div class="card sticky-top">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="settings#useradd-4" class="list-group-item list-group-item-action useradd-4">{{ __('Forum') }}
                                <div class="float-end"></div>
                            </a>

                            <a href="settings#useradd-5" class="list-group-item list-group-item-action useradd-5">{{ __('Support') }}
                                <div class="float-end"></div>
                            </a>
                ...
                <div class="col-xl-9">
                        ...
                        <div class="card-body">
                            ...
                            <div class="">
                                <div class=" row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            {{ Form::label('name', __('Bootcamp Price'), ['class' => 'form-label']) }}
                                            <input type="number" name="bootcamp_price" class="form-control"
                                                value="{{get_option('bootcamp_price')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            {{ Form::label('name', __('Marketing Banner'), ['class' => 'form-label']) }}
                                            <div class="bg-light text-center">
                                                {!! form::image($logo . '/marketing_banner.png', null, ['class' => 'img-responsive my-2 text-center logo_img']) !!}
                                            </div>
                                            {!! form::file('marketing_banner', ['class' => 'form-control', 'accept' => 'image/png']) !!}
                                        </div>
                            ...
                            <div class=" row mt-3 container-fluid">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('mail_driver', get_option('mail_driver'), ['class' => 'form-control', 'placeholder' => __('Enter Mail Driver')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('mail_host', __('Mail Host'), ['class' => 'form-label']) }}
                                        {{ Form::text('mail_host', get_option('mail_host'), ['class' => 'form-control ', 'placeholder' => __('Enter Mail Driver')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('mail_port', __('Mail Port'), ['class' => 'form-label']) }}
                                        {{ Form::text('mail_port', get_option('mail_port'), ['class' => 'form-control', 'placeholder' => __('Enter Mail Port')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('mail_username', __('Mail Username'), ['class' => 'form-label']) }}
                                        {{ Form::text('mail_username', get_option('mail_username'), ['class' => 'form-control', 'placeholder' => __('Enter Mail Username')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('mail_password', __('Mail Password'), ['class' => 'form-label']) }}
                                        {{ Form::text('mail_password', get_option('mail_password'), ['class' => 'form-control', 'placeholder' => __('Enter Mail Password')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('mail_encryption', __('Mail Encryption'), ['class' => 'form-label']) }}
                                        {{ Form::text('mail_encryption', get_option('mail_encryption'), ['class' => 'form-control', 'placeholder' => __('Enter Mail Encryption')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('mail_from_address', __('Mail From Address'), ['class' => 'form-label']) }}
                                        {{ Form::text('mail_from_address', get_option('mail_from_address'), ['class' => 'form-control', 'placeholder' => __('Enter Mail From Address')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('mail_from_name', __('Mail From Name'), ['class' => 'form-label']) }}
                                        {{ Form::text('mail_from_name', get_option('mail_from_name'), ['class' => 'form-control', 'placeholder' => __('Enter Mail Encryption')]) }}
                                    </div>
                                </div>
                    ...
                    <div id="useradd-4" class="card">
                        <div class="card-header">
                            <h5> {{ __('Forum Settings') }}</h5>
                        </div>
                        {{ Form::open(['route' => 'settings.forums', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class=" row mt-3 container-fluid">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('community_forum', __('Community Forum'), ['class' => 'form-label']) }}
                                        {{ Form::text('community_forum', get_option('community_forum'), ['class' => 'form-control', 'placeholder' => __('Enter Community Forum')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('whatsapp_private', __('WhatsApp Private Group'), ['class' => 'form-label']) }}
                                        {{ Form::text('whatsapp_private', get_option('whatsapp_private'), ['class' => 'form-control ', 'placeholder' => __('Enter WhatsApp Private Group')]) }}
                                    </div>
                                </div>
                    ...
                    <div id="useradd-5" class="card">
                        <div class="card-header">
                            <h5> {{ __('Support Settings') }}</h5>
                        </div>
                        {{ Form::open(['route' => 'settings.support', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class=" row mt-3 container-fluid">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('support_hotline', __('Support Hotline'), ['class' => 'form-label']) }}
                                        {{ Form::text('support_hotline', get_option('support_hotline'), ['class' => 'form-control', 'placeholder' => __('Enter Support Hotline')]) }}
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('support_whatsapp', __('Support WhatsApp'), ['class' => 'form-label']) }}
                                        {{ Form::text('support_whatsapp', get_option('support_whatsapp'), ['class' => 'form-control ', 'placeholder' => __('Enter Support WhatsApp')]) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('support_email', get_option('support_email'), ['class' => 'form-control ', 'placeholder' => __('Enter Support Email')]) }}
                                    </div>
                                </div>
