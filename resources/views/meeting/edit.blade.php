                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('batch', $batches, $meeting->batch_id, ['class' => 'form-control select2', 'id' => 'batchSelect', 'placeholder' => __('Select a Batch')]) !!}
                                </div>

                                <div class="form-group">
                                    {{ Form::label('assignuser', __('Select User'), ['class' => 'col-form-label']) }}
                                    {!! Form::select('user', $users, $meeting->user_id, ['class' => 'form-control select2', 'id' => 'User_Select', 'placeholder' => __('Select User')]) !!}
                                </div>

                                <div class="form-group">
                                    {{ Form::label('employee', __('Select Employee'), ['class' => 'col-form-label']) }}
                                    {!! Form::select('employee_id', $employees, $meeting->employee_id, ['class' => 'form-control select2', 'id' => 'employee', 'placeholder' => __('Select Employee')]) !!}
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group" id="datetimepicker" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                        ...
                                        data-datetime="{{ old('datetime', $meeting->main_date_time ? \Carbon\Carbon::parse($meeting->main_date_time)->format('m/d/Y h:i') : '') }}"
             value="{{ old('datetime', $meeting->main_date_time ? \Carbon\Carbon::parse($meeting->main_date_time)->format('m/d/Y h:i') : '') }}" name="datetime" data-td-target="#datetimepicker"  />
