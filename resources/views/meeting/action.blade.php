<div class="dropdown dash-h-item">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        ...
        <a href="{{ route('meetings.index') }}" class="dropdown-item  text-danger" data-toggle="tooltip"
            data-original-title="{{ __('Delete') }}" onclick="delete_record('delete-form-{{ $meeting->id }}')"><i
                class="ti ti-trash action-btn"></i>{{ __('Delete') }}</a>
        {!! Form::open(['method' => 'DELETE', 'route' => ['meetings.destroy', $meeting->id], 'id' => 'delete-form-' . $meeting->id]) !!}
        {!! Form::close() !!}
    </div>
</div>
