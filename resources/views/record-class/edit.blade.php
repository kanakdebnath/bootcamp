...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('record-classes.index') }}">{{ __('Record Class') }}</a></li>
        <li class="breadcrumb-item">{{ __('Edit Record Class') }}
        </li>
    </ul>
@endsection
@push('style')
            ...
            <div class="col-md-8 m-auto">
                <div class="card ">
                    <div class="card-header">
                        <h5> {{ __('Edit Record Class') }}</h5>
                    </div>
                    {!! Form::model($class, ['method' => 'PATCH', 'route' => ['record-classes.update', $class->id]]) !!}
                    <div class="card-body">
