...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">{{ __('Edit Task') }}
        </li>
    </ul>
@endsection
@push('style')
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('employee_id', $users, $task->employee_id, ['class' => 'form-control select2', 'id' => 'employee', 'placeholder' => __('Select Employee')]) !!}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('status', [
                                ...
                                'Deliverd' => 'Deliverd'
                            ], $task->status, ['class' => 'form-select', 'id' => 'statusSelect', 'aria-label' => 'Default select example']) !!}
                        </div>
