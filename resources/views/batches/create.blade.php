...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">{{ __('Create Batch') }}</li>
    </ul>
@endsection
@push('style')
<style>
                    ...
                    <div class="col-md-8 m-auto">
                        <div class="card ">
                            <div class="card-header">
                                <h5> {{ __('Create Batch') }}</h5>
                            </div>
                            {!! Form::open(['route' => 'batches.store', 'method' => 'POST']) !!}
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    {!! Form::select('users[]', $users, null, ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                                </div>
