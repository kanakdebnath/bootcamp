...
class UnpaidUsersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function (User $user) {
                return view('unpaid-users.action', compact('user'));
            });
    }
    ...
    {
        return $model->newQuery()->where('id','!=',1)->where('type', 'user')->where('payment_status', '0')->orderBy('id', 'ASC');
    }
