...
class MemberController extends Controller
{
    ...
    public function index(MembersDataTable $table)
    {
        if (\Auth::user()->can('manage-user')) {

        return $table->render('members.index');
    } else {
    ...
    public function edit($id)
    {
        ...
        return view('members.edit', compact('user', 'roles', 'userRole'));
    } else {
        return redirect()->back()->with('error', 'Permission denied.');
    }
    }
    ...
    public function destroy($id)
    {
        ...
        if($id==1)
        {
            ...
            return redirect()->route('members.index')->with('success', __('User delete successfully.'));
