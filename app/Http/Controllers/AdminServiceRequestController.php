...
class AdminServiceRequestController extends AppBaseController
{

    public function index(ServiceRequestDataTable $table)
    {
        if (\Auth::user()->can('manage-service')) {
            return $table->render('service-request.index');
        } else {
